...
//
//     final aanimemodel = aanimemodelFromJson(jsonString);

import 'dart:convert';

List<Aanimemodel> aanimemodelFromJson(String str) => List<Aanimemodel>.from(
    json.decode(str).map((x) => Aanimemodel.fromJson(x)));

String aanimemodelToJson(List<Aanimemodel> data) =>
...
class Aanimemodel {
  ...
  factory Aanimemodel.fromJson(Map<String, dynamic> json) => Aanimemodel(
        // malId: json["mal_id"],
        // url: json["url"],
